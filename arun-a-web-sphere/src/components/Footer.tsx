...
//       {/* Scroll to top button - adjusted for overflow-x hidden */}
//       <motion.button
//         onClick={scrollToTop}
//         className="fixed bottom-8 right-8 p-3 bg-cyan-500/80 hover:bg-cyan-500 text-white rounded-full shadow-lg backdrop-blur-sm z-50"
...
//         style={{
//           // Ensure the button doesn't cause horizontal overflow
