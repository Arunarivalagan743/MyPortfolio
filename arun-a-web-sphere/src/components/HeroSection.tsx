...
//   return (
//     <section id="home" className="min-h-screen flex items-center justify-center bg-[#030014] pt-16 relative overflow-hidden">
//       {/* Modern gradient background */}
//       <div className="absolute inset-0 w-full h-full bg-[#030014]">
//         <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#4D00B4]/30 rounded-full filter blur-[120px] opacity-20"></div>
//         <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#00BFFF]/20 rounded-full filter blur-[120px] opacity-20"></div>
...
//             {/* Image container */}
//             <div className="relative bg-gradient-to-b from-transparent to-[#070024] w-72 h-72 md:w-[340px] md:h-[340px] rounded-full overflow-hidden border border-white/10 backdrop-blur-sm shadow-xl">
//               <img
//                 src={myImage}
//                 alt="Profile"
//                 className="w-full h-full object-cover"
...
//                   { icon: <SiLeetcode />, href: "https://leetcode.com/u/Arun_774/", color: "#F89F1B" }
//                 ].map((social, index) => (
//                   <motion.a
//                     key={index}
//                     href={social.href}
//                     target="_blank"
//                     rel="noopener noreferrer"
//                     className="p-3 bg-white/5 border border-white/10 rounded-full flex items-center justify-center hover:bg-white/10 transition-colors relative"
//                     whileHover={{ 
//                       scale: 1.15,
...
//       <motion.div
//         className="absolute bottom-6 md:bottom-10 left-1/2 transform -translate-x-1/2 cursor-pointer z-20"
//         animate={{ 
//           y: [0, 8, 0],
//           opacity: [0.7, 1, 0.7],
//         }}
...
//           <span className="text-sm font-light text-cyan-400/80">Scroll down</span>
//           <div className="w-8 h-12 rounded-full border border-cyan-500/30 flex items-center justify-center bg-white/5 backdrop-blur-sm">
//             <FaChevronDown className="text-cyan-400 animate-bounce text-sm" />
//           </div>
//         </div>
//       </motion.div>
