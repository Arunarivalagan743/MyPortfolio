...
import { motion, AnimatePresence, useInView } from 'framer-motion';
import { FaGithub, FaExternalLinkAlt, FaReact, FaNodeJs, FaChevronLeft, FaChevronRight } from 'react-icons/fa';
import { SiHackerearth, SiTailwindcss, SiRedux, SiMongodb, SiExpress, SiFlutter, SiPython, SiFirebase, SiGooglecloud } from 'react-icons/si';
...
const mainProjects = [
  {
    ...
    image: travellaImg,
    tech: ['React', 'Tailwind CSS', 'Firebase', 'Google Maps API', 'Gemini AI'],
    techIcons: [
      { Icon: FaReact, color: '#61DAFB', name: 'React', proficiency: 92 },
      { Icon: SiTailwindcss, color: '#06B6D4', name: 'Tailwind CSS', proficiency: 90 },
      { Icon: SiFirebase, color: '#FFCA28', name: 'Firebase', proficiency: 85 },
      { Icon: SiGooglecloud, color: '#4285F4', name: 'Google Maps', proficiency: 80 },
      { Icon: ({ className, style }) => (
