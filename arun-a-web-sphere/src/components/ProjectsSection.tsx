    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <motion.button 
            onClick={handlePrev}
            className="absolute top-1/2 left-4 -translate-y-1/2 backdrop-blur-sm text-white p-3 rounded-full transition-all duration-300 z-10"
          ...
          <motion.button 
            onClick={handleNext}
            className="absolute top-1/2 right-4 -translate-y-1/2 backdrop-blur-sm text-white p-3 rounded-full transition-all duration-300 z-10"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
